...
<前回課題>
断熱火炎温度Tf: 2946.8229710346272
排気速度: 3960.1485553296707
finert: 0.12019562166614232
ペイロード比: 0.05745012526182873
推力: 444148.72698204056

<Gas Generator Cycle>
xmin: 0.06860000000000001
p: 6.96
pump_power: 806210.334380411
turbin_power: 806208.6453527681
断熱火炎温度Tf: 2946.8229710346272
排気速度: 3960.1485553296707
finert: 0.1233406210126462
ペイロード比: 0.05710165934540462
推力: 446859.16823629907

<Staged Combustion Cycle>
断熱火炎温度Tf: 3182.1257954775865
排気速度: 4115.220652966596
finert: 0.12019562166614232
ペイロード比: 0.07081674392223822
推力: 360315.9166428043
----------------------------------------------------------------------------------------------
...
def gasg_pump_power(y,p):
    powp = p*pow(10,6)
    ans = (3.3 + 1.94*y)*1.2*powp/(1.14*1000*0.7) + (1 + 2.16*y)*1.6*20.64*pow(10,6)/(71*0.7)
    return ans
...
if __name__ == '__main__':
    ...
    print("排気速度:",Vj(3.1,tc))
    print("finert:",Finert(2.95))
    print("ペイロード比:",Payload_Ratio(2.95,gasg_tc))
    print("推力:",Thrust(2.95,gasg_tc))
    print("")
